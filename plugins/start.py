...
async def start(client, message):
    ...
    loading_sticker_message = await message.reply_sticker("CAACAgUAAxkBAAKIvGcx2B4shDnnF0jibRmtnxGH_66eAAIuEgACbwyQVfGuR5QwHwU9NgQ")
    await asyncio.sleep(2)
    await loading_sticker_message.delete()
    
    text = f"""Hello {message.from_user.mention} \n\n➻ This Is An Advanced And Yet Powerful Rename Bot.\n\n➻ Using This Bot You Can Rename And Change Thumbnail Of Your Files.\n\n➻ You Can Also Convert Video To File Aɴᴅ File To Video.\n\n➻ This Bot Also Supports Custom Thumbnail And Custom Caption.\n\n<b>Bot Is Made By @ultroid_official</b>"""
    
    button = InlineKeyboardMarkup([
        [InlineKeyboardButton("📢 Updates", url="https://t.me/ultroid_official"),
        InlineKeyboardButton("💬 Support", url="https://t.me/ultroidxTeam")],
        [InlineKeyboardButton("🛠️ Help", callback_data='help'),
        InlineKeyboardButton("❤️‍🩹 About", callback_data='about')],
        [InlineKeyboardButton("🧑‍💻 Developer 🧑‍💻", url="https://t.me/PhdLust")]
        ])
